...
const tipoPeca = 'torre';
const posicaoInicial = 'a2';
const posicaoFinal = 'a4';
const jogador = 'jogador1';
...
xhr.send(`tipo_peca=${tipoPeca}&posicao_inicial=${posicaoInicial}&posicao_final=${posicaoFinal}&jogador=${jogador}`);